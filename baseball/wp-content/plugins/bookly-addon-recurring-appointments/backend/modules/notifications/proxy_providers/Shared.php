...
class Shared extends Proxy\Shared
{
    ...
    {
        $codes['series']['appointment_schedule']   = __( 'recurring appointments schedule', 'bookly-recurring-appointments' );
        $codes['series']['appointment_schedule_c'] = __( 'recurring appointments schedule with cancel', 'bookly-recurring-appointments' );
        $codes['series']['approve_appointment_schedule_url'] = __( 'URL for approving the whole schedule', 'bookly-recurring-appointments' );
        $codes['series']['recurring_count']        = __( 'recurring appointments', 'bookly-recurring-appointments' );
