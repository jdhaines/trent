    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-title h2"><?php _e( 'Delete Appointment', 'bookly-recurring-appointments' ) ?></div>
            </div>
            <div class="modal-body">
                <div class="radio">
                    <label>
                        <input type="radio" name="delete-series" value="" checked />
                        <?php _e( 'Delete only this appointment', 'bookly-recurring-appointments' ) ?>
                    </label>
                    <br>
                    <label class="bookly-margin-top-sm">
                        <input type="radio" name="delete-series" value="current-and-next" class="bookly-js-delete-series" />
                        <?php _e( 'Delete this and the following appointments', 'bookly-recurring-appointments' ) ?>
                    </label>
                    <br>
                    <label class="bookly-margin-top-sm">
                        <input type="radio" name="delete-series" value="series" class="bookly-js-delete-series" />
                        <?php _e( 'Delete all appointments in series', 'bookly-recurring-appointments' ) ?>
                    </label>
                </div>
                <div class="checkbox">
                    <label>
            ...
            <div class="modal-footer">
                ...
                <?php Buttons::renderCustom( null, 'btn btn-lg btn-default', __( 'Cancel', 'bookly' ), array( 'data-dismiss' => 'modal' ) ) ?>
            </div>
        </div>
    </div>
</div>