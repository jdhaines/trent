    ...
    ?>
      <div class="ak-container">  
        ...
        <div class="service-block-wrapper clearfix">
            ...
            $i++
            ?>
            <div class="service-<?php echo esc_attr($i); ?> service-block">
                    ...
                    <div class="service-content">
                        <?php echo esc_html(accesspress_excerpt(get_the_content(), 250, true)); ?>
                    </div>
            </div>
            <?php
            endwhile;
...
<?php if(of_get_option('enable_pricing')==1)
{
   ...
   <section class="pricing-table">
        <div class="ak-container">
            ...
            <h2 class="topic home-title"><?php echo esc_html($ak_pricing_title); ?></h2>
            <div class="pricing-table-desc home-description"><?php echo wp_kses_post($ak_pricing_desc); ?></div>
            <?php
           ...
           ?><div class="<?php if ($a%2==0){echo 'aw-right';} else{ echo 'aw-left';}?>">
                <div class="aw-wrapper clearfix">
                    <div class="aw-content">
                        ...
                        <div class="aw-excerpt"><?php echo esc_html(accesspress_excerpt(get_the_content(), 120)); ?></div>
                    </div>
...
?>
              ...
              <div class="portfolio-content">
                ...
                <div class="port-content"><?php echo esc_html(accesspress_excerpt(get_the_content(), 50, true)); ?></div>
            </div>
              </div>
            </div>
            <?php
...
?>
    <section class="clients-logo">
        <div class="ak-container">
            ...
            <div class="clearfix clients-logo-wrapper <?php if(of_get_option('view_type_clients')=='scroll'){ echo esc_html(of_get_option('view_type_clients')); } else{ echo esc_html(of_get_option('view_type_clients')); } ?>">
            <?php 
            foreach($ak_cl_img as $ak_img){
                $img_link = wp_get_attachment_image_src($ak_img['image'],'full');
                ?>
            <div class="client-slider">
                <a href="<?php echo esc_url($ak_img['link']); ?>">
                    <img alt="client-logo" src="<?php echo esc_url($img_link[0]);?>" />
                </a>
            </div>
            <?php }
            ?>
         ...
         ?>
            ...
            ?>
                <div class="team-hover">
                    ...
                    <div class="team-hover-text"><?php echo esc_html(accesspress_excerpt(get_the_content(), 60)); ?></div>
                </div>
                </figure>
        ...
        <div class="blog-desc"><?php echo wp_kses_post(of_get_option('blog_desc')); ?></div>
           ...
           <?php
                ...
                ?><div class="blog-in-wrap">
                    ...
                    <a href="<?php echo  esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));  ?>"><div class="blog-author"><i class="fa fa-user"></i><?php the_author(); ?></div></a>
                    ...
                    <div class="blog-content"><?php echo esc_html(accesspress_excerpt(get_the_content(), 120)); ?>
    ...
    <div class="testimonial-wrap">
        <div class="ak-container">
            ...
            <div class="testimonial-slider">
                ...
                ?>
                <div class="tm-slider">
                    <?php echo esc_html(accesspress_excerpt(get_the_content(), 220)); ?>
...
<?php 
    if(of_get_option('enable_posts') == 1 ){ ?>
                    ...
                    <footer class="entry-footer">
                        <?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
                            ...
                            <span class="cat-links">
                                <?php /* translators: %s : category list */ printf( wp_kses(__( 'Posted in %1$s', 'accesspress-staple' ), array( 'a' => array( 'href' => array(), 'rel' => array() ) )), wp_kses( $categories_list, array( 'a' => array( 'href' => array(), 'rel' => array() ) ) ) ); ?>
                            </span>
                            ...
                            <span class="tags-links">
                                <?php /* translators: %1$s : taglist */ printf( wp_kses(__( 'Tagged %1$s', 'accesspress-staple' ), array( 'a' => array( 'href' => array(), 'rel' => array() ) )), wp_kses( $tags_list, array( 'a' => array( 'href' => array(), 'rel' => array() ) ) ) ); ?>
                            </span>
