...
<div id="page" class="hfeed site">
    <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'accesspress-staple' ); ?></a>
    <div id="outer-wrap">
        <div id="inner-wrap">            
            <?php 
                $ak_logo_alignment = '';
                ...
                <div class="ak-container" id="main-header">
                    ...
                    <div class="menu-wrap <?php echo esc_attr($ak_nav_alignment); ?>">
                        ...
                        <nav id="site-navigation" class="main-navigation" role="navigation">
                            <button class="menu-toggle"><?php esc_html_e( 'Primary Menu', 'accesspress-staple' ); ?></button>
