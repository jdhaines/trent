...
if ( !function_exists( 'of_get_option' ) ) {
   ...
   function of_get_option( $option, $default = '' ) {
       $accesspress_staple_options = get_option( 'accesspress-staple' );

       if ( isset( $accesspress_staple_options[ $option ] ) ) {
           return $accesspress_staple_options[ $option ];
       } else {
           return $default;
       }
   }
...
function accesspress_staple_scripts() {
	...
	wp_enqueue_style( 'accesspress-staple-keyboard-css', get_template_directory_uri() . '/css/keyboard.css');
...
/**
 * Load Options Woocommerce Hooks.
 */
